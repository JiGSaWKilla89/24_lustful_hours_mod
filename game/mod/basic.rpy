...
init 1:#Mod Defaults
    ...
    define gui.jg_mod_version = '0.3.0'
    define gui.mod_update_version = 1
    define gui.dev_mod_page = "24_lustful_hours_mod"
    define gui.mod_update_date = "17/10/2024"
    ...
    define gui.developer_name = "Carnal Studio"
    define gui.developer_support = "https://www.patreon.com/CarnalStudio"
...
screen support_mod_developer():
    ...
    vbox:
        ...
        hbox:
            ...
            text " | "
            textbutton "Return to Game" action Hide(),Return()
...
init python:#New
    if persistent._main_menu_track is True:#New
        config.main_menu_music = PunchDeck808Lotus#New
    else:#New
